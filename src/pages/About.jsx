    ...
    return (
        <>
            ...
            <div data-aos="fade-up">
                <div className="flex flex-col md:flex-row  justify-between gap-8 bg-white px-6 py-12 rounded-lg max-w-[1100px] w-full m-auto ">
                ...
                <div className="flex flex-col-reverse md:flex-row  justify-between gap-8 bg-white px-6 rounded-lg max-w-[1100px] w-full m-auto ">
